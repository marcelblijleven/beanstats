    ...
    <Card>
      ...
      <CardContent>
        <div className={"grid grid-cols-1 md:grid-cols-2 gap-2"}>
          ...
          <LabelledValue
            label={"Roaster"}
            value={decoded.roaster}
            type={"string"}
          />
          <LabelledValue
            type={"date"}
            label={"Buy date"}
            value={decoded.buyDate}
          />
          <LabelledValue
            type={"date"}
            label={"Roasting date"}
            value={decoded.roastingDate}
          />
          {decoded.roast !== Roast.CUSTOM_ROAST && (
            <LabelledValue
              type={"string"}
              label={"Roast"}
              value={Roast[decoded.roast ?? 0]}
            />
          )}
          ...
          {decoded.roast === Roast.CUSTOM_ROAST && (
            <LabelledValue
              type={"string"}
              label={"Roast (custom)"}
              value={decoded.roastCustom}
            />
          )}
          <LabelledValue
            type={"string"}
            label={"Bean mix"}
            value={BeanMix[decoded.beanMix ?? 0]}
          />
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent>
        <div className={"grid grid-cols-1 md:grid-cols-2 gap-2"}>
          ...
          <LabelledValue
            ...
            value={decoded.aromatics}
            splitLabels
          />
          <LabelledValue
            type={"string"}
            label={"Cupping points"}
            value={decoded.cuppingPoints}
          />
          <LabelledValue
            type={"boolean"}
            label={"Decaffeinated"}
          ...
          <LabelledValue
            type={"string"}
            label={"EAN"}
            value={decoded.eanArticleNumber}
          />
        </div>
        {!!decoded.note && (
          <LabelledValue type={"string"} label={"Notes"} value={decoded.note} />
        )}
      </CardContent>
    </Card>
  </>
  ...
  <Card>
    ...
    <CardContent>
      <div className={"grid grid-cols-2 gap-2"}>
        ...
        />
        <LabelledValue
          label={"Bean certification"}
          value={info.certification}
          type={"string"}
        />
        <LabelledValue
          label={"Purchase price"}
          value={info.purchasingPrice}
          type={"number"}
        />
        <LabelledValue
          label={"FOB price"}
